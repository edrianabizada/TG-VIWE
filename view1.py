...
os.system('xdg-open https://youtube.com/@Best_Hacker')
...
|         {G}[+] ᴅᴇᴠᴇʟᴏᴘᴇʀ : {B}EDRIS NABIZADA            |
|         {G}[+] ɢɪᴛʜᴜʙ ᴜsᴇʀɴᴀᴍᴇ   : {B}EDRISNABIZADA     |
|         {G}[+] ᴛᴇʟᴇɢʀᴀᴍ ᴜsᴇʀɴᴀᴍᴇ : {B}@EDRISNABIZADA420 |
|         {G}[+] ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀɴɴᴇʟ  : {B}@BEST_HACKER00420 |
{E}=====================================================''')
def tui():
    while True:
        print(logo)
